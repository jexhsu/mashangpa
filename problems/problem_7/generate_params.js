...
function X(p, L) {
    ...
    for (U = 0; U < p.length; U += 16) {
        H = Z(
            (H = Z(
                (H = Z(
                    (H = Z(
                                                        ...
                                                        (H = S(
                                                            (H = S(
                                                                ...
                                                                (m = S(
                                                                    ...
                                                                    (Q = S(
                                                                        Q,
                                                                        (b = S(b, H, m, Q, p[U + 8], 7, 1770035416)),
                                                                        H,
                                                                        m,
                                                                        p[U + 9],
                                                                        12,
                        ...
                        (m = Z(
                            m,
                            (Q = Z(Q, (b = Z(b, H, m, Q, p[U], 6, -198630844)), H, m, p[U + 7], 10, 1126891415)),
                            b,
                            H,
                            p[U + 14],
                            15,
                    ...
                    (m = Z(
                        m,
                        (Q = Z(Q, (b = Z(b, H, m, Q, p[U + 12], 6, 1700485571)), H, m, p[U + 3], 10, -1894986606)),
                        b,
                        H,
                        p[U + 10],
                        15,
                ...
                (m = Z(
                    m,
                    (Q = Z(Q, (b = Z(b, H, m, Q, p[U + 8], 6, 1873313359)), H, m, p[U + 15], 10, -30611744)),
                    b,
                    H,
                    p[U + 6],
                    15,
            ...
            (m = Z(
                m,
                (Q = Z(Q, (b = Z(b, H, m, Q, p[U + 4], 6, -145523070)), H, m, p[U + 11], 10, -1120210379)),
                b,
                H,
                p[U + 2],
                15,
...
function K(p, v) {
    return (function (j, E) {
        var b,
            ...
            Q = [],
            U = [];
        for (Q[15] = U[15] = void 0, 16 < m.length && (m = X(m, 8 * j.length)), b = 0; b < 16; b += 1) {
            Q[b] = 909522486 ^ m[b];
            U[b] = 1549556828 ^ m[b];
        }
...
function generateParams() {
    ...
    const x = encodeURIComponent(sha256(m + "xxoo").toString());
